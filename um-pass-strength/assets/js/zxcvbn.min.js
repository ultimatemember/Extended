                  ...
                  (feedback = {
                     ...
                     get_feedback: function(e, s) {
                        ...
                        return (
                           ...
                           null != feedback
                              ? (feedback.suggestions.unshift(a), null == feedback.warning && (feedback.warning = ""))
                     ...
                     get_dictionary_match_feedback: function(e, s) {
                        ...
                        return (
                           ...
                           o.match(scoring.START_UPPER)
                              ...
                              : o.match(scoring.ALL_UPPER) && r.push("All-uppercase is almost as easy to guess as all-lowercase"),
            ...
            function(require, module, exports) {
               ...
               (matching = require("./matching")),
                  ...
                  (zxcvbn = function(e, t) {
                     ...
                     for (null == t && (t = []), g = time(), u = [], c = 0, s = t.length; s > c; c++)
                        (i = t[c]), ("string" == (m = typeof i) || "number" === m || "boolean" === m) && u.push(i.toString().toLowerCase());
         ...
         5: [
            function(require, module, exports) {
               ...
               (GRAPHS = {
                  ...
                  (SEQUENCES = { lower: "abcdefghijklmnopqrstuvwxyz", upper: "ABCDEFGHIJKLMNOPQRSTUVWXYZ", digits: "0123456789" }),
                  (L33T_TABLE = {
                     a: ["4", "@"],
                     b: ["8"],
                     c: ["(", "{", "[", "<"],
                  ...
                  (matching = {
                     ...
                     dictionary_match: function(e, t) {
                        ...
                        for (n in t)
                           for (l = t[n], r = o = 0, _ = a; _ >= 0 ? _ > o : o > _; r = _ >= 0 ? ++o : --o)
                              for (i = h = f = r, d = a; d >= f ? d > h : h > d; i = d >= f ? ++h : --h)
                                 ...
                                 for (a = t[0], E = t.slice(1), u = [], d = e[a], l = 0, h = d.length; h > l; l++)
                                    for (o = d[l], _ = 0, c = g.length; c > _; _++) {
                                       ...
                                       -1 === i
                                          ...
                                          : ((y = m.slice(0)), y.splice(i, 1), y.push([o, a]), u.push(m), u.push(y));
                                    }
                                 return (g = n(u)), r(E);
                              }
                           }),
                     ...
                     spatial_match_helper: function(e, t, n) {
                        ...
                        for (f = [], c = 0; c < e.length - 1; )
                           for (u = c + 1, l = null, E = 0, p = ("qwerty" !== n && "dvorak" !== n) || !this.SHIFTED_RX.exec(e.charAt(c)) ? 0 : 1; ; ) {
                              ...
                              if (!o) {
                                 u - c > 2 && f.push({ pattern: "spatial", i: c, j: u - 1, token: e.slice(c, u), graph: n, turns: E, shifted_count: p }),
                                    (c = u);
                                 break;
                              }
                              u += 1;
                     ...
                     repeat_match: function(e) {
                        var t, n, r, i, a, s, o, h, c, u, l, _, f, d, g;
                        for (
                           d = [], a = /(.+)\1+/g, u = /(.+?)\1+/g, l = /^(.+?)\1+$/, c = 0;
                           c < e.length && ((a.lastIndex = u.lastIndex = c), (s = a.exec(e)), (_ = u.exec(e)), null != s);

                        )
                           s[0].length > _[0].length ? ((f = s), (i = l.exec(f[0])[1])) : ((f = _), (i = f[1])),
                              ...
                              for (t = h[o], n = 0; n < e.length; )
                                 if (((c = e.charAt(n)), indexOf.call(u, c) < 0)) n += 1;
                                    ...
                                    for (
                                       ...
                                       r < e.length && ((s = this.mod(_ + t, u.length)), u.indexOf(e.charAt(r)) === s);
                     ...
                     regex_match: function(e, t) {
                        ...
                        for (name in t)
                           for (r = t[name], r.lastIndex = 0; (i = r.exec(e)); )
                              (a = i[0]), n.push({ pattern: "regex", token: a, i: i.index, j: i.index + i[0].length - 1, regex_name: name, regex_match: i });
                        return this.sorted(n);
                     },
                     date_match: function(e) {
                        var t, n, r, i, a, s, o, h, c, u, l, _, f, d, g, p, E, m, y, A, v, I, R, x, T, N, k, D, S, j, b, q, C, O;
                        for (
                           _ = [], f = /^\d{4,8}$/, d = /^(\d{1,4})([\s\/\\_.-])(\d{1,2})\2(\d{1,4})$/, s = E = 0, v = e.length - 4;
                           v >= 0 ? v >= E : E >= v;
                           s = v >= 0 ? ++E : --E
                        )
                           for (o = m = I = s + 3, R = s + 7; (R >= I ? R >= m : m >= R) && !(o >= e.length); o = R >= I ? ++m : --m)
                              if (((O = e.slice(s, +o + 1 || 9e9)), f.exec(O))) {
                                 for (r = [], x = DATE_SPLITS[O.length], y = 0, u = x.length; u > y; y++)
                                    (T = x[y]),
                                       (h = T[0]),
                                       (c = T[1]),
                                       (a = this.map_ints_to_dmy([parseInt(O.slice(0, h)), parseInt(O.slice(h, c)), parseInt(O.slice(c))])),
                                       null != a && r.push(a);
                                 if (r.length > 0) {
                                    for (
                                       t = r[0],
                                       ...
                                       (n = N[A]), (i = g(n)), p > i && ((k = [n, i]), (t = k[0]), (p = k[1]));
                                    _.push({ pattern: "date", token: O, i: s, j: o, separator: "", year: t.year, month: t.month, day: t.day });
                                 }
                              }
                        for (s = q = 0, D = e.length - 6; D >= 0 ? D >= q : q >= D; s = D >= 0 ? ++q : --q)
                           for (o = C = S = s + 5, j = s + 9; (j >= S ? j >= C : C >= j) && !(o >= e.length); o = j >= S ? ++C : --C)
                              (O = e.slice(s, +o + 1 || 9e9)),
                                 (b = d.exec(O)),
                                 null != b &&
                                    ((a = this.map_ints_to_dmy([parseInt(b[1]), parseInt(b[3]), parseInt(b[4])])),
                                    null != a && _.push({ pattern: "date", token: O, i: s, j: o, separator: b[2], year: a.year, month: a.month, day: a.day }));
                        return this.sorted(
                           _.filter(function(e) {
                              var t, n, r, i;
                        ...
                        if (!(e[1] > 31 || e[1] <= 0)) {
                           ...
                           if (!(h >= 2 || 3 === o || g >= 2)) {
                              for (
                                 ...
                                 if (((_ = u[c]), (p = _[0]), (d = _[1]), p >= DATE_MIN_YEAR && DATE_MAX_YEAR >= p))
                                    return (t = this.map_ints_to_dm(d)), null != t ? { year: p, month: t.month, day: t.day } : void 0;
                              for (l = 0, a = u.length; a > l; l++)
                                 if (((f = u[l]), (p = f[0]), (d = f[1]), (t = this.map_ints_to_dm(d)), null != t))
                                    return (p = this.two_to_four_digit_year(p)), { year: p, month: t.month, day: t.day };
                           }
                        }
                     },
                     map_ints_to_dm: function(e) {
                        ...
                        for (a = [e, e.slice().reverse()], i = 0, n = a.length; n > i; i++)
                           if (((s = a[i]), (t = s[0]), (r = s[1]), t >= 1 && 31 >= t && r >= 1 && 12 >= r)) return { day: t, month: r };
                     },
                  ...
                  (scoring = {
                           ...
                           for (r[c] = [], C[c] = [], U = 1 / 0, G = I = 0, m = M; m >= 0 ? m >= I : I >= m; G = m >= 0 ? ++I : --I)
                              for (
                                 o = !0,
                                    ...
                                    0 === G
                                       ? ((s = 0), (v = 1))
                                       : "bruteforce" === (null != (O = r[c - 1]) && null != (P = O[G]) ? P.pattern : void 0)
                                       ? ((s = r[c - 1][G].i), (v = G))
                                    ...
                                    o &&
                                       ...
                                       v > 1 && (i *= C[T][v - 1]),
                                       (u = D(i, v)),
                                       U > u && ((U = u), (C[c][v] = i), (N = v), (M = Math.max(M, v)), (r[c][v] = _))),
                                    d = 0,
                                    f = t.length;
                                 f > d;
                                 d++
                                 ...
                                 if (((R = t[d]), R.j === c)) {
                                    ...
                                    (i = this.estimate_guesses(R, e)),
                                       G > 0 && (i *= C[E - 1][G]),
                                       (u = D(i, G + 1)),
                                       U > u && ((U = u), (C[c][G + 1] = i), (N = G + 1), (M = Math.max(M, G + 1)), (r[c][G + 1] = R));
                                 }
                        for (p = [], l = N, c = e.length - 1; c >= 0; ) (R = r[c][l]), p.push(R), (c = R.i - 1), (l -= 1);
                        return p.reverse(), (h = 0 === e.length ? 1 : U), { password: e, guesses: h, guesses_log10: this.log10(h), sequence: p };
                     },
                     ...
                     bruteforce_guesses: function(e) {
                        ...
                        return (
                           ...
                           (n = 1 === e.token.length ? MIN_SUBMATCH_GUESSES_SINGLE_CHAR + 1 : MIN_SUBMATCH_GUESSES_MULTI_CHAR + 1),
                           Math.max(t, n)
                        );
                     },
                     ...
                     sequence_guesses: function(e) {
                        ...
                        return (
                           (n = e.token.charAt(0)),
                           (t = "a" === n || "A" === n || "z" === n || "Z" === n || "0" === n || "1" === n || "9" === n ? 4 : n.match(/\d/) ? 10 : 26),
                           e.ascending || (t *= 2),
                           t * e.token.length
                        );
                     },
                     ...
                     regex_guesses: function(e) {
                        var t, n;
                        if (((t = { alpha_lower: 26, alpha_upper: 26, alpha: 52, alphanumeric: 62, digits: 10, symbols: 33 }), e.regex_name in t))
                     ...
                     date_guesses: function(e) {
                        var t, n;
                        return (
                           (n = Math.max(Math.abs(e.year - this.REFERENCE_YEAR), this.MIN_YEAR_SPACE)),
                           (t = 31 * n * 12),
                           e.has_full_year && (t *= 2),
                           e.separator && (t *= 4),
                           t
                     ...
                     spatial_guesses: function(e) {
                        ...
                        for (
                           "qwerty" === (g = e.graph) || "dvorak" === g
                              ? ((A = this.KEYBOARD_STARTING_POSITIONS), (s = this.KEYBOARD_AVERAGE_DEGREE))
                           ...
                           for (h = Math.min(R, _ - 1), i = o = 1, l = h; l >= 1 ? l >= o : o >= l; i = l >= 1 ? ++o : --o)
